                        ...
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                <form action="{{ route('admin.products.update', $product) }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        >
                                            @foreach($colors as $color)
                                                <option
                                                        @if(collect(old('color_id'))->contains($color->id) || $product->colors->contains($color->id))
                                                            selected
                                                        @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        >
                                            @foreach($sizes as $size)
                                                <option
                                                        @if(collect(old('size_id'))->contains($size->id) || $product->sizes->contains($size->id))
                                                            selected
                                                        @endif
                                    ...
                                    <div class="mb-3">
                                        <label for="thumbnail" class="my-2">Thumbnail*</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="first_image" class="my-2">First Image</label>
                                        <input type="file"
                                    ...
                                    <div class="mb-3">
                                        <label for="second_image" class="my-2">Second Image</label>
                                        <input type="file"
                                    ...
                                    <div class="mb-3">
                                        <label for="third_image" class="my-2">Third Image</label>
                                        <input type="file"
